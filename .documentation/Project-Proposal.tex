...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.1\textwidth]{appicon.png}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.35\textwidth]{animated chicken.png}
    \caption{Proposed Chicken Animation}
\end{figure}

\subsection{Bucket Asset}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.35\textwidth]{Bucket.png}
    \caption{Proposed Bucket Asset}
\end{figure}

\subsection{Egg Asset}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.35\textwidth]{Egg.png}
    \caption{Proposed Egg Asset}
\end{figure}
